...
public class Main extends Application {
		...
		public void start(Stage primaryStage) {
			Text hello = new Text(50, 50, "Will we meet again?");
			Text question = new Text(120, 80, 
			...
			Scene scene = new Scene(root, 800, 600, Color.rgb(39, 32, 92));
	
			primaryStage.setTitle("Unknown Individual");
